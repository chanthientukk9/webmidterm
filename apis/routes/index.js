...
router.route('/driver/me/update-location')
    .put(auth(generalRole), routeDriver.updateLocation)
router.route('driver/me/begin')
    .get(auth(generalRole), routeDriver.setBegin)
router.route('driver/me/finish')
    .get(auth(generalRole), routeDriver.setFinish)
